...
% 2008March17 - added capacity to blur when concatenate
function runGLM_spmHRF_blur
...
for iExpt = 2 % 1:length(exptList)
  ...
  for iSubj = 2 % 1:length(subjList)
    ...
    for iModel = 2:3
      ...
      if(1)
        blur = 1; % set to 1 if want to spatially blur the data
        view = junkAndCat(view, ran2, blur);
      end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function view = junkAndCat(view,ran2,blur)
global MLR
