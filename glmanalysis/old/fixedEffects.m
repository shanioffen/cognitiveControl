% 2008March19 - based on runGLM_bySubjExpt
% code to do a fixed-effects analysis for all subjects

function fixedEffects

whichModel = {'default','corrDelay','corrTrial','split'};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function view = junkAndCat(view,blur)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
global MLR;
