...
function runNewGLM(subj,expt,inputModelNum)
...
for iModel = inputModelNum
  ...
  if strcmp(model,'split'), split = 1; model = 'corrTrial'; else, split = 0; end
  ...
  params.DM = getDM('subj','expt','model');
