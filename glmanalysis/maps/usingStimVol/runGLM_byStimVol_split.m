...
function runGLM_byStimVol_split(subj,expt)
...
params.saveName = ['glm_split_FDR_' model];
...
params.subjRunList = []; % not splitting data for fixed effects
...
if split, params.scanNum = 2:3;
else, params.scanNum = 1; end
...
% run the GLM
[view d] = GLMbyStimVol_FDR(view,params);
