...
switch model
  ...
  case {'corrDelay','corrDelay_S2plus'}
    [r2 dpContrast s1 dpCorrect dpWrong s2] = setOverlays(view,params); 
  case {'corrTrial','corrTrial_S2plus'}
...
dpContrast.interrogator = 'eventRelatedPlot_so';
...
switch model
  ...
  case {'corrDelay','corrDelay_S2plus'}
    ...
    dpCorrect.interrogator = 'eventRelatedPlot_so';
    ...
    dpWrong.interrogator = 'eventRelatedPlot_so';
  ...
  case {'corrTrial','corrTrial_S2plus'}
    ...
    s1Correct.interrogator = 'eventRelatedPlot_so';
    ...
    s2Correct.interrogator = 'eventRelatedPlot_so';
    ...
    s1Wrong.interrogator = 'eventRelatedPlot_so';
    ...
    s2Wrong.interrogator = 'eventRelatedPlot_so';
