function [epochR2 betasROI] = estimateBetas(subj,expt,restrict,HRFnum,redo,doplot)
...
ROIlist = {'leftAntCS','leftDMsPCS','leftDLsPCS','leftIPCS','leftPostIPS',...
           ...
           'leftCing','leftSupBig','leftInfBig','rightCing','rightSupBig','rightInfBig'};
...
for iRoi = 1:numRoi
  ...
  if doplot
    ...
    xlim([-4 30]);
    ylim([-0.4 0.8])
    title(sprintf('d = %0.2f, r2 = %0.2f',betas(2),epochR2));
