function [epochR2 betasROI] = estimateBetas_new(subj,expt) %(,restrict,HRFnum,redo,doplot,ROIlist,nR,nC)
...
%
% 2009Sept23 - put rest in name of ROI because restricting IPS by vis localizer
...
ROIlist = {...
    'leftDMsPCS_restCan25','leftDLsPCS_restCan25','leftIPS_resVis',...
    'rightDMsPCS_restCan25','rightDLsPCS_restCan25','rightIPS_resVis'...
          };
nR = 2; nC= 3;
...
if doplot
  graphName = [graphDir expt '_dataPlots_' subj];
