function [epochR2 betasROI] = estimateBetas(subj,expt,restrict,HRFnum,redo,doplot,ROIlist,nR,nC)
...
if isempty(ROIlist)
  ROIlist = {...
           ...
           'leftAntCS','leftCing','leftIPS',...
           'rightAntCS','rightCing','rightIPS',...
            };
  nR = 4; nC= 3;
end
...
if doplot
  graphName = [graphDir expt '_dataPlotsIPS_' subj];
