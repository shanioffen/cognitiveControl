function plotDvals_checkIPS(restrict,HRFnum)
...
ROIlist = {...
           'leftDMsPCS','leftDLsPCS','leftIPCS','leftAntCS','leftCing','leftIPS',...
           'rightDMsPCS','rightDLsPCS','rightIPCS','rightAntCS','rightCing','rightIPS',...
          };
nR = 2; nC= 6;

ROIlist = {'IPS1','IPS2','leftIPS','rightIPS'};
nR = 4; nC = 2;
...
for iRoi = 1:numRoi
  ...
  % save as ill file
  if iRoi == numRoi
    graphName = '/Users/shani/NYU/NYUdocuments/thesis/figures/Ch4/data/dPlotTestIPS_MAIN';
    switch whichHRF
      case 'Can'
  ...
  for iSubj = 1:numSubj
    ...
    secondPlotNum = secondPlotNum +1
    figure(figNum+1), subplot(nR,nC,secondPlotNum);
    ...
    if iRoi == numRoi
      graphName = ['/Users/shani/NYU/NYUdocuments/thesis/figures/Ch4/data/dPlotTestIPS'];
      switch whichHRF
        case 'Can'
          graphName = [graphName '_cannonHRF'];
        case 'Est'
