...
for iRoi = 1:numRoi
  ...
  % save as ill file
  if iRoi == numRoi
    graphName = '/Users/shani/NYU/NYUdocuments/thesis/figures/Ch4/data/dPlotIPS_MAIN';
    switch whichHRF
      case 'Can'
  ...
  for iSubj = 1:numSubj
    ...
    if iRoi == numRoi
      graphName = ['/Users/shani/NYU/NYUdocuments/thesis/figures/Ch4/data/dPlotIPS' subj];
      switch whichHRF
        case 'Can'
          graphName = [graphName '_cannonHRF'];
        case 'Est'
