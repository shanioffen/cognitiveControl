function plotDvals_combineHS_DELETE(restrict,HRFnum)
...
for iExpt = 1:numExpt
  ...
  % save as ill file
  if iRoi == numRoi
    graphName = '/Users/shani/NYU/NYUdocuments/thesis/figures/Ch4/data/1moreRoi/dPlot_bilat';
    switch whichHRF
      case 'Can'
  ...
  for iSubj = 1:numSubj
    ...
    if iRoi == numRoi
      graphName = ['/Users/shani/NYU/NYUdocuments/thesis/figures/Ch4/data/1moreRoi/dPlotBilat' subj];
      switch whichHRF
        case 'Can'
          graphName = [graphName '_cannonHRF'];
        case 'Est'
