function mkDM_s2plusOL_master(subj,expt)
...
dataName = [saveDir 'DM_correctTrialS2plusOL_' expt '_' subj];
...
for iRun = 1:totalRuns
  ...
  stimFile = [stimDir 'stimFile_corrTrial_S2plusOL_' num2str(iRun) '.mat'];
