function mkDM_correct_master(subj,expt)
...
% These are obsolete but put them here in case I miss them in the code
DMtype = 'wOL';
delayCut = 0;
...
dataName1 = [saveDir 'DM_correctDelay_' expt '_' subj];
dataName2 = [saveDir 'DM_correctTrial_' expt '_' subj];
...
for iRun = 1:totalRuns
  ...
  stimFile = [stimDir 'stimFile_corrDelay_' num2str(iRun) '.mat'];
  ...
  stimFile = [stimDir 'stimFile_corrTrial_' num2str(iRun) '.mat'];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Subfunction to set directories
