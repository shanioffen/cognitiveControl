function mkDM_extraS2_master(subj,expt)
...
dataName1 = [saveDir 'DM_correctDelayS2plus_' expt '_' subj];
dataName2 = [saveDir 'DM_correctTrialS2plus_' expt '_' subj];
...
for iRun = 1:totalRuns
  ...
  stimFile = [stimDir 'stimFile_corrDelay_S2plus_' num2str(iRun) '.mat'];
  ...
  stimFile = [stimDir 'stimFile_corrTrial_S2plus_' num2str(iRun) '.mat'];
