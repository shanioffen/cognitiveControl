...
%if strfind(gUsername,'justin') && ~strcmp('justin',gUsername)
%  disp(sprintf('UHOH: username is %s',gUsername));
%  keyboard
%end
...
global initpath;
initname = 'smartfig';
% add the username to the filename
%global gUsername;
%fullinitname = sprintf('%s_%s',initname,gUsername);
